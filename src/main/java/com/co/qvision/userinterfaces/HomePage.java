...
public class HomePage {
    ...
    public static final Target CHECKED_RADIO = Target.the("Seleccionar Checkbox ").locatedBy("//input[@id='my-radio-1']");
    public static final Target DEFAULT_RADIO = Target.the("Seleccionar Checkbox ").locatedBy("//input[@id='my-radio-2']");
    public static final Target COLOR_PICKER = Target.the("Seleccionar Checkbox ").locatedBy("//input[@name='my-colors']");
